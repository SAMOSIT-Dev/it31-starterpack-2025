...
export default function WhyApplyCard({children, set}) {
    return (
        <div className={`w-[320px] rounded-[25px] bg-linear-89 from-4% via-49% to-99% 
        ...
        ${set === 'C' ? "to-[#403382]" : set === 'B' ? "to-[#44B0B0]" : "to-[#7E0001]"}`}>
            <div className="border border-[#636363] w-[320px] h-[395px] rounded-[25px] bg-linear-to-b from-black to-black/83 flex flex-col items-center
            mb-1">
