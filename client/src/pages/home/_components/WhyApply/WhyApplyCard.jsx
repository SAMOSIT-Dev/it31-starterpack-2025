...
export default function WhyApplyCard({Header, content, set}) {
    return (
        <div className={`w-[290px] h-[340px] rounded-[25px] bg-linear-to-r 
        ...
        ${set === 'C' ? "to-[#403382]" : set === 'B' ? "to-[#44B0B0]" : "to-[#7E0001]"}`}>
            <div className="border border-[#636363] w-[290px] h-[335px] rounded-[25px] bg-linear-to-b from-black to-black/83 flex flex-col items-center">
                ...
                <div className='font-inter'>
                    <h6 className='font-medium text-white text-[13px] text-center'>Header</h6>
                    <p className='text-[#AAAAAA] text-center text-[13px] font-medium px-7' >Lorem, ipsum dolor sit amet consectetur adipisicing elit. Cupiditate dolorem sed amet optio hic aut temporibus architecto ipsa velit delectus.</p>
                </div>
            </div>
        </div>
    )
